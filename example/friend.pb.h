...
template<> ::fixbug::RequestCode* Arena::CreateMaybeMessage<::fixbug::RequestCode>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace fixbug {
...
class RequestCode final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.RequestCode) */ {
 public:
  inline RequestCode() : RequestCode(nullptr) {}
  ~RequestCode() override;
  explicit PROTOBUF_CONSTEXPR RequestCode(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const RequestCode& from) {
    RequestCode::MergeImpl(*this, from);
  }
  private:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.RequestCode)
 private:
  class _Internal;
...
class GetFriendListResponse final :
 ...
 public:
  ...
  // .fixbug.RequestCode result = 1;
  bool has_result() const;
  private:
  bool _internal_has_result() const;
  public:
  void clear_result();
  const ::fixbug::RequestCode& result() const;
  PROTOBUF_NODISCARD ::fixbug::RequestCode* release_result();
  ::fixbug::RequestCode* mutable_result();
  void set_allocated_result(::fixbug::RequestCode* result);
  private:
  const ::fixbug::RequestCode& _internal_result() const;
  ::fixbug::RequestCode* _internal_mutable_result();
  public:
  void unsafe_arena_set_allocated_result(
      ::fixbug::RequestCode* result);
  ::fixbug::RequestCode* unsafe_arena_release_result();
...
class FriendServerRpc_Stub;

class FriendServerRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline FriendServerRpc() {};
 public:
  virtual ~FriendServerRpc();

  typedef FriendServerRpc_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(FriendServerRpc);
};

class FriendServerRpc_Stub : public FriendServerRpc {
 public:
  FriendServerRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  FriendServerRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
                   ::PROTOBUF_NAMESPACE_ID::Service::ChannelOwnership ownership);
  ~FriendServerRpc_Stub();

  inline ::PROTOBUF_NAMESPACE_ID::RpcChannel* channel() { return channel_; }

  // implements FriendServerRpc ------------------------------------------
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(FriendServerRpc_Stub);
};
...
// int32 errcode = 1;
inline void RequestCode::clear_errcode() {
  _impl_.errcode_ = 0;
}
inline int32_t RequestCode::_internal_errcode() const {
  return _impl_.errcode_;
}
inline int32_t RequestCode::errcode() const {
  // @@protoc_insertion_point(field_get:fixbug.RequestCode.errcode)
  return _internal_errcode();
}
inline void RequestCode::_internal_set_errcode(int32_t value) {
  
  _impl_.errcode_ = value;
}
inline void RequestCode::set_errcode(int32_t value) {
  _internal_set_errcode(value);
  // @@protoc_insertion_point(field_set:fixbug.RequestCode.errcode)
}

// bytes errmsg = 2;
inline void RequestCode::clear_errmsg() {
  _impl_.errmsg_.ClearToEmpty();
}
inline const std::string& RequestCode::errmsg() const {
  // @@protoc_insertion_point(field_get:fixbug.RequestCode.errmsg)
  return _internal_errmsg();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RequestCode::set_errmsg(ArgT0&& arg0, ArgT... args) {
 
 _impl_.errmsg_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fixbug.RequestCode.errmsg)
}
inline std::string* RequestCode::mutable_errmsg() {
  std::string* _s = _internal_mutable_errmsg();
  // @@protoc_insertion_point(field_mutable:fixbug.RequestCode.errmsg)
  return _s;
}
inline const std::string& RequestCode::_internal_errmsg() const {
  return _impl_.errmsg_.Get();
}
inline void RequestCode::_internal_set_errmsg(const std::string& value) {
  
  _impl_.errmsg_.Set(value, GetArenaForAllocation());
}
inline std::string* RequestCode::_internal_mutable_errmsg() {
  
  return _impl_.errmsg_.Mutable(GetArenaForAllocation());
}
inline std::string* RequestCode::release_errmsg() {
  // @@protoc_insertion_point(field_release:fixbug.RequestCode.errmsg)
  return _impl_.errmsg_.Release();
}
inline void RequestCode::set_allocated_errmsg(std::string* errmsg) {
  if (errmsg != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.RequestCode.errmsg)
}
...
inline const ::fixbug::RequestCode& GetFriendListResponse::_internal_result() const {
  const ::fixbug::RequestCode* p = _impl_.result_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::RequestCode&>(
      ::fixbug::_RequestCode_default_instance_);
}
inline const ::fixbug::RequestCode& GetFriendListResponse::result() const {
...
inline ::fixbug::RequestCode* GetFriendListResponse::release_result() {
  
  ::fixbug::RequestCode* temp = _impl_.result_;
  _impl_.result_ = nullptr;
...
inline ::fixbug::RequestCode* GetFriendListResponse::unsafe_arena_release_result() {
...
inline ::fixbug::RequestCode* GetFriendListResponse::_internal_mutable_result() {
  
  if (_impl_.result_ == nullptr) {
    auto* p = CreateMaybeMessage<::fixbug::RequestCode>(GetArenaForAllocation());
    _impl_.result_ = p;
  }
  return _impl_.result_;
}
inline ::fixbug::RequestCode* GetFriendListResponse::mutable_result() {
  ::fixbug::RequestCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponse.result)
  return _msg;
}
inline void GetFriendListResponse::set_allocated_result(::fixbug::RequestCode* result) {
