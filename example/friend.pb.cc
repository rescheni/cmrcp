...
namespace fixbug {
PROTOBUF_CONSTEXPR RequestCode::RequestCode(
...
struct RequestCodeDefaultTypeInternal {
  PROTOBUF_CONSTEXPR RequestCodeDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RequestCodeDefaultTypeInternal _RequestCode_default_instance_;
...
const uint32_t TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::RequestCode, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::RequestCode, _impl_.errcode_),
  PROTOBUF_FIELD_OFFSET(::fixbug::RequestCode, _impl_.errmsg_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "endListResponse\022#\n\006result\030\001 \001(\0132\023.fixbug"
...
RequestCode::RequestCode(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:fixbug.RequestCode)
}
RequestCode::RequestCode(const RequestCode& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RequestCode* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.RequestCode)
}
...
RequestCode::~RequestCode() {
  // @@protoc_insertion_point(destructor:fixbug.RequestCode)
...
// @@protoc_insertion_point(message_clear_start:fixbug.RequestCode)
...
const char* RequestCode::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* RequestCode::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.RequestCode)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.RequestCode)
  return target;
}

size_t RequestCode::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.RequestCode)
  size_t total_size = 0;
...
void RequestCode::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RequestCode*>(&to_msg);
  auto& from = static_cast<const RequestCode&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:fixbug.RequestCode)
...
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.RequestCode)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class GetFriendListResponse::_Internal {
 public:
  static const ::fixbug::RequestCode& result(const GetFriendListResponse* msg);
};

const ::fixbug::RequestCode&
...
GetFriendListResponse::GetFriendListResponse(const GetFriendListResponse& from)
  ...
  if (from._internal_has_result()) {
    _this->_impl_.result_ = new ::fixbug::RequestCode(*from._impl_.result_);
  }
...
void GetFriendListResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_result()) {
    _this->_internal_mutable_result()->::fixbug::RequestCode::MergeFrom(
...
FriendServerRpc::~FriendServerRpc() {}

const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* FriendServerRpc::descriptor() {
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* FriendServerRpc::GetDescriptor() {
  return descriptor();
}

void FriendServerRpc::GetFriendList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void FriendServerRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServerRpc::GetRequestPrototype(
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServerRpc::GetResponsePrototype(
    const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
FriendServerRpc_Stub::FriendServerRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel)
  : channel_(channel), owns_channel_(false) {}
FriendServerRpc_Stub::FriendServerRpc_Stub(
...
void FriendServerRpc_Stub::GetFriendList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
template<> PROTOBUF_NOINLINE ::fixbug::RequestCode*
Arena::CreateMaybeMessage< ::fixbug::RequestCode >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::RequestCode >(arena);
}
